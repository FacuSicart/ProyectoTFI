...
namespace ProyectoTFI.Controllers
{
    public class Solicitud_SoporteController : Controller
    {
        ...
        {
            Solicitud_Respuesta SR = new Solicitud_Respuesta(DescripcionRespuesta, DateTime.Now, solicitud.ID, ((Administrador)((Usuario)Session["user"]).Administrador.First()).ID);
